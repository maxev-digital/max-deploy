    ...
    <>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 14, marginBottom: 20 }}>
        ...
        <div style={{ background: cb, border: `1px solid ${bd}`, borderRadius: 14, padding: '18px 14px 12px' }}>
          ...
          <div style={{ fontSize: '1.45rem', fontWeight: 900, color: green, lineHeight: 1, marginBottom: 8 }}>${((v?.mrr ?? 0) / 1000).toFixed(1)}k</div>
        ...
        <div>
          ...
          <div style={{ background: cb, border: `1px solid ${bd}`, borderRadius: 14, padding: '18px 20px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 14 }}>
              <span style={{ fontSize: '0.63rem', fontWeight: 700, letterSpacing: '0.14em', color: '#C8C8C8', textTransform: 'uppercase' }}>Pipeline Stage Breakdown</span>
        ...
        <div>
          ...
          <div style={{ background: cb, border: `1px solid ${bd}`, borderRadius: 14, padding: '18px 16px', marginBottom: 14 }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: 14 }}>
              <div style={{ fontSize: '3rem', fontWeight: 900, lineHeight: 1, color: gradeColor }}>{loading ? '...' : health?.grade ?? '—'}</div>
